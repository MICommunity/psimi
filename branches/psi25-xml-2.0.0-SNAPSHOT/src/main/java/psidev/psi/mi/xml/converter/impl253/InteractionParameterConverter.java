...
public class InteractionParameterConverter {
    ...
    public psidev.psi.mi.xml.model.Parameter fromJaxb( psidev.psi.mi.xml253.jaxb.InteractionElementType.ParameterList.Parameter jParameter ) throws ConverterException {
        ...
        // experiment
        if ( jParameter.getExperimentRef() != null ) {
...
//            mParameter.setExperiment( experimentDescription );
    ...
    public psidev.psi.mi.xml253.jaxb.InteractionElementType.ParameterList.Parameter toJaxb( psidev.psi.mi.xml.model.Parameter mParameter ) throws ConverterException {
        ...
        psidev.psi.mi.xml253.jaxb.InteractionElementType.ParameterList.Parameter jParameter =
                new psidev.psi.mi.xml253.jaxb.InteractionElementType.ParameterList.Parameter();
