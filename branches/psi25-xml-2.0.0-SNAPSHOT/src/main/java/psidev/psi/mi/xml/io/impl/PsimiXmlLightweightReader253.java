 ...
 * @since 1.0
 */
public class PsimiXmlLightweightReader253 implements PsimiXmlLightweightReader {

    private static final Log log = LogFactory.getLog( PsimiXmlLightweightReader253.class );
    ...
    public PsimiXmlLightweightReader253( File xmlDataFile ) throws PsimiXmlReaderException {
        init( xmlDataFile );
    }

    public PsimiXmlLightweightReader253( URL url ) throws PsimiXmlReaderException {
        if ( url == null ) {
    ...
    public PsimiXmlLightweightReader253( InputStream is ) throws PsimiXmlReaderException {
        if ( is == null ) {
