 ...
 * @see psidev.psi.mi.xml253.jaxb.ParticipantType.ParticipantIdentificationMethodList.ParticipantIdentificationMethod
...
public class ParticipantIdentificationMethodConverter {
    ...
    fromJaxb( psidev.psi.mi.xml253.jaxb.ParticipantType.ParticipantIdentificationMethodList.ParticipantIdentificationMethod jParticipantIdentificationMethod )
            throws ConverterException {
    ...
    public psidev.psi.mi.xml253.jaxb.ParticipantType.ParticipantIdentificationMethodList.ParticipantIdentificationMethod
    toJaxb( psidev.psi.mi.xml.model.ParticipantIdentificationMethod mParticipantIdentificationMethod ) throws ConverterException {
        ...
        // 1. convert the CvType
        psidev.psi.mi.xml253.jaxb.ParticipantType.ParticipantIdentificationMethodList.ParticipantIdentificationMethod jParticipantIdentificationMethod =
                cvTypeConverter.toJaxb( mParticipantIdentificationMethod,
                                        psidev.psi.mi.xml253.jaxb.ParticipantType.ParticipantIdentificationMethodList.ParticipantIdentificationMethod.class );
    ...
    protected void addExperimentRef( psidev.psi.mi.xml253.jaxb.ParticipantType.ParticipantIdentificationMethodList.ParticipantIdentificationMethod participantIdentificationMethod,
                                     int experimentRef ) {
        if ( participantIdentificationMethod.getExperimentRefList() == null ) {
            participantIdentificationMethod.setExperimentRefList( new ExperimentRefListType() );
        }
