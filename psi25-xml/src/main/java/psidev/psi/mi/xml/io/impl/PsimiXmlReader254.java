...
public class PsimiXmlReader254 implements PsimiXmlReader {
    ...
    public psidev.psi.mi.xml.model.EntrySet read( Reader reader ) throws PsimiXmlReaderException {
        ...
        psidev.psi.mi.xml254.jaxb.EntrySet jEntrySet = unmarshall( reader );
    ...
    private psidev.psi.mi.xml254.jaxb.EntrySet unmarshall( Reader reader ) throws PsimiXmlReaderException {
        ...
        try {
            ...
            psidev.psi.mi.xml254.jaxb.EntrySet es = ( psidev.psi.mi.xml254.jaxb.EntrySet ) u.unmarshal( reader );
