...
/**
 * Unit tester for ExpandedXmlWriter
 *
...
public class ExpandedXml25WriterTest {
    ...
    public void test_not_initialised_writer() {
        ExpandedXmlWriter writer = new ExpandedXmlWriter();
    ...
    public void test_single_interaction_mix() throws XMLStreamException {
        ...
        ModelledParticipant participant2 = new DefaultModelledParticipant(complex.getParticipants().iterator().next().getInteractor());
        interaction2.addParticipant(participant2);
