...
public class UnambiguousCooperativeEffectBaseComparatorTest {

    private UnambiguousCooperativeEffectBaseComparator comparator = new UnambiguousCooperativeEffectBaseComparator();
    ...
    public void test_cooperative_effect_null_after() throws Exception {
        ...
        Assert.assertFalse(UnambiguousCooperativeEffectBaseComparator.areEquals(effect1, effect2));
        Assert.assertTrue(UnambiguousCooperativeEffectBaseComparator.hashCode(effect1) != UnambiguousCooperativeEffectBaseComparator.hashCode(effect2));
    }
    ...
    public void test_compare_same_outcome() throws Exception {
        ...
        Assert.assertTrue(UnambiguousCooperativeEffectBaseComparator.areEquals(effect1, effect2));
        Assert.assertTrue(UnambiguousCooperativeEffectBaseComparator.hashCode(effect1) == UnambiguousCooperativeEffectBaseComparator.hashCode(effect2));
    }
