 ...
 * @since 1.0
 */
public class PsimiXmlReader254Test {

    ////////////////////////////////
    // Compatibility with JUnit 3

    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter( PsimiXmlReader254Test.class );
    }
    ...
    public void checkInteractorSequence() throws Exception {
        File file = new File( PsimiXmlReader254Test.class.getResource("/sample-xml/intact/10320477.v2.254.xml").getFile() );
    ...
    public void read_file() throws Exception {
        File file = new File( PsimiXmlReader254Test.class.getResource("/sample-xml/intact/10320477.254.xml").getFile() );
        PsimiXmlReader254 reader = new PsimiXmlReader254();
        EntrySet es = reader.read( file );
        Assert.assertNotNull( es );
    }
