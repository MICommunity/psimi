...
public class SpokeExpansionTest {
    ...
    @Test
    public void expand() throws JAXBException, IOException, ConverterException, PsimiXmlReaderException {
        ...
        // 3 is the bait, 5 and 8 the preys, we should find 2 interaction involving participant 3/5 and 3/8
        ...
        for ( Interaction i : interactions ) {
            ...
            if ( hasParticipant( i, 3, 5 ) ) {
                ...
                fail( "Could not find either participant 3/5 or 3/8." );
            }
        } // for
