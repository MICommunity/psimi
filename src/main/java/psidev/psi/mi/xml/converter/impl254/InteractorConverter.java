 ...
 * @see psidev.psi.mi.xml254.jaxb.Interactor
...
public class InteractorConverter {
    ...
    public psidev.psi.mi.xml.model.Interactor fromJaxb( psidev.psi.mi.xml254.jaxb.Interactor jInteractor ) throws ConverterException {
        ...
        if ( jInteractor.getAttributeList() != null ) {
            for ( psidev.psi.mi.xml254.jaxb.Attribute attribute : jInteractor.getAttributeList().getAttributes() ) {
    ...
    public psidev.psi.mi.xml254.jaxb.Interactor toJaxb( psidev.psi.mi.xml.model.Interactor mInteractor ) throws ConverterException {
        ...
        psidev.psi.mi.xml254.jaxb.Interactor jInteractor = new psidev.psi.mi.xml254.jaxb.Interactor();
