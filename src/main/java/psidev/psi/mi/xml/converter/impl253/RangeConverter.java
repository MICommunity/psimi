 ...
 * @see psidev.psi.mi.xml253.jaxb.BaseLocationType
...
public class RangeConverter {
    ...
    public psidev.psi.mi.xml.model.Range fromJaxb( psidev.psi.mi.xml253.jaxb.BaseLocationType jRange ) throws ConverterException {
    ...
    public psidev.psi.mi.xml253.jaxb.BaseLocationType toJaxb( psidev.psi.mi.xml.model.Range mRange ) {

        if ( mRange == null ) {
            throw new IllegalArgumentException( "You must give a non null model Range." );
        }

        psidev.psi.mi.xml253.jaxb.BaseLocationType jRange = new psidev.psi.mi.xml253.jaxb.BaseLocationType();
