 ...
 * @see psidev.psi.mi.xml253.jaxb.InteractionElementType.InferredInteractionList.InferredInteraction.Participant
...
public class InferredInteractionParticipantConverter {
    ...
    fromJaxb( psidev.psi.mi.xml253.jaxb.InteractionElementType.InferredInteractionList.InferredInteraction.Participant jInferredInteractionParticipant )
            throws ConverterException {
    ...
    public psidev.psi.mi.xml253.jaxb.InteractionElementType.InferredInteractionList.InferredInteraction.Participant
    toJaxb( psidev.psi.mi.xml.model.InferredInteractionParticipant mInferredInteractionParticipant ) throws ConverterException {
        ...
        psidev.psi.mi.xml253.jaxb.InteractionElementType.InferredInteractionList.InferredInteraction.Participant jParticipant =
                new psidev.psi.mi.xml253.jaxb.InteractionElementType.InferredInteractionList.InferredInteraction.Participant();
