...
public class CvTypeConverter {
     ...
     *          psidev.psi.mi.xml254.jaxb.CvType jType = interactor.getInteractorType();
     ...
     */
    public <CV extends psidev.psi.mi.xml.model.CvType> CV fromJaxb( psidev.psi.mi.xml254.jaxb.CvType jCvType,
                                                                    Class<CV> clazz )
            throws ConverterException {
     ...
     * @return
     */
    public psidev.psi.mi.xml254.jaxb.CvType toJaxb( psidev.psi.mi.xml.model.CvType mCvType ) {

        if ( mCvType == null ) {
            throw new IllegalArgumentException( "You must give a non null JAXB OpenCvType." );
        }

        psidev.psi.mi.xml254.jaxb.CvType jCvType = new psidev.psi.mi.xml254.jaxb.CvType();
     ...
     * @return
     */
    public <CV extends psidev.psi.mi.xml254.jaxb.CvType> CV toJaxb( psidev.psi.mi.xml.model.CvType mCvType,
