 ...
 * It will compare the basic properties of a experimental participant using DefaultExactParticipantBaseComparator.
 * It will compare the participant candidates using DefaultExactExperimentalEntityComparator
 *
            ...
            if (participant1 == participant2){
                ...
                while (f1Iterator.hasNext()){
                    ...
                    for (ExperimentalParticipantCandidate f2 : f2List){
                        if (DefaultExactExperimentalEntityComparator.areEquals(f1, f2, checkComplexesAsInteractors)){
                            f2ToRemove = f2;
                            break;
                        }
                    }
