 ...
 * It will compare the basic properties of a biological entity using DefaultExactEntityBaseComparator.
 *
...
public class DefaultExactModelledEntityComparator {
    ...
    public static boolean areEquals(ModelledEntity bioParticipant1, ModelledEntity bioParticipant2, boolean checkComplexesAsInteractors){
        ...
        if (bioParticipant1 == bioParticipant2){
            ...
            if (!DefaultExactEntityBaseComparator.areEquals(bioParticipant1, bioParticipant2, ignoreInteractors)){
                return false;
            }
