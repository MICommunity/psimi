 ...
 * @since 19/06/13
 */
public class FullParticipantPoolEnricher<P extends ParticipantPool, F extends Feature>
        extends FullParticipantEnricher<P,F> implements ParticipantPoolEnricher<P,F> {
