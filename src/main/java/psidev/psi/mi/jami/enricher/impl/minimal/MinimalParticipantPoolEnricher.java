 ...
 * @since 19/06/13
 */
public class MinimalParticipantPoolEnricher<P extends ParticipantPool, F extends Feature>
        extends MinimalParticipantEnricher<P,F> implements ParticipantPoolEnricher<P,F> {
