package psidev.psi.mi.jami.xml.model.extension.factory.xml30;
...
import psidev.psi.mi.jami.xml.model.extension.binary.xml30.XmlBinaryInteractionEvidence;
import psidev.psi.mi.jami.xml.model.extension.binary.xml30.XmlBinaryInteractionEvidenceWrapper;
import psidev.psi.mi.jami.xml.model.extension.binary.xml30.XmlModelledBinaryInteraction;
import psidev.psi.mi.jami.xml.model.extension.binary.xml30.XmlModelledBinaryInteractionWrapper;
...
public class XmlBinaryInteractionFactory implements BinaryInteractionFactory {
    ...
    private void copyXmlInteractionEvidenceProperties(InteractionEvidence interaction,
                                                      psidev.psi.mi.jami.xml.model.extension.xml300.ExtendedPsiXmlInteractionEvidence binary) {
        psidev.psi.mi.jami.xml.model.extension.xml300.ExtendedPsiXmlInteractionEvidence xmlSource =
    ...
    private void copyXmlModelledInteractionProperties(ModelledInteraction interaction, XmlModelledBinaryInteraction binary) {
        ...
        binary.setId(xmlSource.getId());
        binary.getBindingFeatures().clear();
        binary.getBindingFeatures().addAll(xmlSource.getBindingFeatures());
        binary.getCausalRelationships().clear();
        binary.getCausalRelationships().addAll(xmlSource.getCausalRelationships());
        binary.setIntraMolecular(xmlSource.isIntraMolecular());
        binary.setSourceLocator(xmlSource.getSourceLocator());
