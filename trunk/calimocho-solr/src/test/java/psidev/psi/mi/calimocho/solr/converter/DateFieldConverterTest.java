...
public class DateFieldConverterTest extends TestCase {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(DateFieldConverterTest.class);
        return suite;
    }
    ...
    public void testIndexFieldValues_date_mitab27() throws Exception {
        System.out.println("DateField: indexFieldValues - date - mitab2.7");
...
//                System.out.println("field: " + field);
                ...
                solrDoc = dateConverter.indexFieldValues(field, fName, solrDoc, uniques);
