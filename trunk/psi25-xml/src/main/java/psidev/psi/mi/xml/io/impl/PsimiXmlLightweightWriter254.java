 ...
 * @since 1.5.0
 */
public class PsimiXmlLightweightWriter254 implements PsimiXmlLightweightWriter {
    ...
    public PsimiXmlLightweightWriter254( File outputFile ) throws PsimiXmlWriterException {
        ...
        stringWriter = new PsimiXmlStringWriter254();
    }
    ...
    public void writeStartDocument() throws PsimiXmlWriterException {
        writeln( "<entrySet version=\"5\" minorVersion=\"4\" level=\"2\" xsi:schemaLocation=\"http://psi.hupo.org/mi/mif http://psidev.sourceforge.net/mi/rel25/src/MIF254.xsd\" xmlns=\"http://psi.hupo.org/mi/mif\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">" );
    }
