 ...
 * @since 1.5.0
 */
public class PsimiXmlLightweightWriter253Test {
    ...
    public void writeFile() throws Exception {
        ...
        PsimiXmlLightweightWriter253 writer = new PsimiXmlLightweightWriter253( outputFile );
        ...
        if( separator.length() == 2 ) {
            Assert.assertEquals( 43936, outputFile.length() );
        } else if( separator.length() == 1 ){
            Assert.assertEquals( 43927, outputFile.length() );
        } else  {
    ...
    private File getTargetDirectory() {
        String outputDirPath = PsimiXmlLightweightWriter253Test.class.getResource( "/" ).getFile();
