...
/**
 * The default Mitab data source return iterator of interaction evidences
 *
...
public class MitabDataSource extends AbstractMitabDataSource<InteractionEvidence, BinaryInteractionEvidence, ParticipantEvidence>{

    public MitabDataSource() {
        super();
    }

    public MitabDataSource(File file) throws IOException {
        super(file);
    }

    public MitabDataSource(InputStream input) {
        super(input);
    }

    public MitabDataSource(Reader reader) {
        super(reader);
    }
