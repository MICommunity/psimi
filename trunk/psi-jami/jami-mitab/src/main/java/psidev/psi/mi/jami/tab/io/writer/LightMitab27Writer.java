...
public class LightMitab27Writer extends LightMitab26Writer {
    ...
    public LightMitab27Writer(File file, ComplexExpansionMethod<Interaction<? extends Participant>, BinaryInteraction> expansionMethod) throws IOException {
        super(file, expansionMethod);
    }

    public LightMitab27Writer(OutputStream output, ComplexExpansionMethod<Interaction<? extends Participant>, BinaryInteraction> expansionMethod) {
        super(output, expansionMethod);
    }

    public LightMitab27Writer(Writer writer, ComplexExpansionMethod<Interaction<? extends Participant>, BinaryInteraction> expansionMethod) {
