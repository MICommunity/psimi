...
/**
 * Mitab 2.7 feeder for InteractionEvidence
 *
...
public class Mitab27InteractionEvidenceFeeder extends Mitab26InteractionEvidenceFeeder implements Mitab27ColumnFeeder<BinaryInteractionEvidence, ParticipantEvidence>{

    public Mitab27InteractionEvidenceFeeder(Writer writer) {
        super(writer);
    }

    public void writeParticipantFeatures(ParticipantEvidence participant) throws IOException {
        if (participant != null){
    ...
    public void writeParticipantStoichiometry(ParticipantEvidence participant) throws IOException {
        if (participant != null){
