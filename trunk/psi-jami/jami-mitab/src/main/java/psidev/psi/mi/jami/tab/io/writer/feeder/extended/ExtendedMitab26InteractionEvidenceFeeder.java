...
public class ExtendedMitab26InteractionEvidenceFeeder extends Mitab26InteractionEvidenceFeeder {
    public ExtendedMitab26InteractionEvidenceFeeder(Writer writer) {
        super(writer);
    }
