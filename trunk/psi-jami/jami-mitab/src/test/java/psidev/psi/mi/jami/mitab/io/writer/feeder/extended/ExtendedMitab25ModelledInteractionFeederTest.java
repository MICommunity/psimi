...
import psidev.psi.mi.jami.tab.io.writer.feeder.extended.ExtendedMitab25ModelledInteractionFeeder;
...
/**
 * Unit tester for ExtendedMitab25ModelledInteractionFeeder
 *
...
public class ExtendedMitab25ModelledInteractionFeederTest {

    @Test(expected = ClassCastException.class)
    public void write_aliases_no_mitab() throws IOException {
        StringWriter writer = new StringWriter();
        ExtendedMitab25ModelledInteractionFeeder feeder = new ExtendedMitab25ModelledInteractionFeeder(writer);
        ...
        feeder = new ExtendedMitab25ModelledInteractionFeeder(writer);
