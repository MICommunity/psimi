...
public class UnambiguousExperimentalParticipantComparator extends ExperimentalParticipantComparator{
    ...
    private static UnambiguousExperimentalParticipantComparator defaultExperimentalParticipantComparator;
    ...
    public static boolean areEquals(ExperimentalParticipant experimentalParticipant1, ExperimentalParticipant component2){
        if (defaultExperimentalParticipantComparator == null){
            defaultExperimentalParticipantComparator = new UnambiguousExperimentalParticipantComparator();
        }
