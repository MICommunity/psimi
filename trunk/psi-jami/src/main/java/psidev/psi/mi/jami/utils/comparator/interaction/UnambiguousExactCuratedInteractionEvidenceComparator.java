 ...
 * If the experimental interaction properties are the same, it will compare the basic interaction properties using UnambiguousExactCuratedInteractionBaseComparator<ParticipantEvidence>.
 *
 *
...
public class UnambiguousExactCuratedInteractionEvidenceComparator extends InteractionEvidenceComparator {
    ...
    /**
     * Creates a new UnambiguousExactCuratedInteractionEvidenceComparator. It will use a UnambiguousExactCuratedInteractionBaseComparator to
    ...
    public UnambiguousExactCuratedInteractionEvidenceComparator() {
        super(new CuratedInteractionBaseComparator<ParticipantEvidence>(new UnambiguousExactParticipantEvidenceComparator(), new UnambiguousCvTermComparator()),
