...
public class DefaultExactAllostericInteractionComparator extends AllostericInteractionComparator{
    ...
    public DefaultExactAllostericInteractionComparator() {
        super(new DefaultExactCooperativeInteractionComparator(), new DefaultCvTermComparator(), new DefaultExactComponentComparator(), new DefaultBiologicalFeatureComparator());
    }
