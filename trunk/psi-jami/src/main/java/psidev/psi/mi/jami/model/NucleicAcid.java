...
public interface NucleicAcid extends Interactor {
     ...
     * It is a shortcut which should point to the first DDBJ/EMBL/GenBank identifier in the list of identifiers.
     ...
     * It will remove the old DDBJ/EMBL/GemBank identifier from the list of identifiers and replace it
