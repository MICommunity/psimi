 ...
 * If the properties of a nucleic acid were not enough to compare the nucleic acids, it will use UnambiguousInteractorComparator to compare the interactor properties
...
public class UnambiguousNucleicAcidComparator extends NucleicAcidComparator {
    ...
    /**
     * Creates a new UnambiguousNucleicAcidComparator. It will uses a UnambiguousInteractorComparator to compare interactor properties and a
