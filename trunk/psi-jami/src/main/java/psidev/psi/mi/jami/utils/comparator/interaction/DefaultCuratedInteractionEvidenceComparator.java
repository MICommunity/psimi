 ...
 * If the experimental interaction properties are the same, it will compare the basic interaction properties using DefaultCuratedInteractionBaseComparator<ParticipantEvidence>.
 *
 *
...
public class DefaultCuratedInteractionEvidenceComparator extends InteractionEvidenceComparator {
    ...
    public DefaultCuratedInteractionEvidenceComparator() {
        super(new CuratedInteractionBaseComparator<ParticipantEvidence>(new DefaultParticipantEvidenceComparator(), new DefaultCvTermComparator()),
