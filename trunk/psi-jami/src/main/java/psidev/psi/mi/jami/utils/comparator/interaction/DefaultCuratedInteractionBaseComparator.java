...
public class DefaultCuratedInteractionBaseComparator extends CuratedInteractionBaseComparator {
    ...
    private static DefaultCuratedInteractionBaseComparator defaultCuratedInteractionComparator;

    /**
     * Creates a new DefaultCuratedInteractionBaseComparator. It will use a DefaultParticipantBaseComparator to
    ...
    public static boolean areEquals(Interaction interaction1, Interaction interaction2){
        if (defaultCuratedInteractionComparator == null){
            defaultCuratedInteractionComparator = new DefaultCuratedInteractionBaseComparator();
        }
