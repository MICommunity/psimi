...
public class DefaultExactCuratedInteractionBaseComparator extends CuratedInteractionBaseComparator {

    private static DefaultExactCuratedInteractionBaseComparator defaultExactCuratedInteractionComparator;

    /**
     * Creates a new DefaultExactCuratedInteractionBaseComparator. It will use a DefaultParticipantBaseComparator to
     * compare participants and DefaultCvTermcomparator to compare interaction types
     */
    public DefaultExactCuratedInteractionBaseComparator() {
    ...
    /**
     * Use DefaultExactCuratedInteractionBaseComparator to know if two interactions are equals.
     * @param interaction1
     * @param interaction2
    ...
    public static boolean areEquals(Interaction interaction1, Interaction interaction2){
        if (defaultExactCuratedInteractionComparator == null){
            defaultExactCuratedInteractionComparator = new DefaultExactCuratedInteractionBaseComparator();
        }
