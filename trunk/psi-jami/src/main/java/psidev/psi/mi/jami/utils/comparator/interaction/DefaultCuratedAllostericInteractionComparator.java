...
public class DefaultCuratedAllostericInteractionComparator extends AllostericInteractionComparator{
    ...
    public DefaultCuratedAllostericInteractionComparator() {
        super(new DefaultCuratedCooperativeInteractionComparator(), new DefaultCvTermComparator(), new DefaultComponentComparator(), new DefaultBiologicalFeatureComparator());
    }
