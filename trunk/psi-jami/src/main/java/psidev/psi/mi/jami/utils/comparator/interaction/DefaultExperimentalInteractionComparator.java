...
public class DefaultExperimentalInteractionComparator extends ExperimentalInteractionComparator{
    ...
    /**
     * Creates a new DefaultExperimentalInteractionComparator. It will use a DefaultExactInteractionComparator to
    ...
    public DefaultExperimentalInteractionComparator() {
        super(new InteractionComparator<ExperimentalParticipant>(new DefaultExperimentalParticipantComparator(), new DefaultCvTermComparator()),
