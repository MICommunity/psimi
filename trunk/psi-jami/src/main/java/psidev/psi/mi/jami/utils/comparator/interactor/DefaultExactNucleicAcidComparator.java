 ...
 * If the properties of a nucleic acid were not enough to compare the nucleic acids, it will use DefaultExactInteractorBaseComparator to compare the interactor properties
 *
 *
