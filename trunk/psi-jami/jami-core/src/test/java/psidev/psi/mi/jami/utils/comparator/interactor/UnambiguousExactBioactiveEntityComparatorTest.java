...
/**
 * Unit tester for UnambiguousExactBioactiveEntityComparator
 *
...
public class UnambiguousExactBioactiveEntityComparatorTest {
    ...
    public void test_interactor_properties_before_checksums(){
        ...
        BioactiveEntity interactor2 = new DefaultBioactiveEntity("test");
        // different interactor type because exact comparator compares interactor types
    ...
    @Test
    public void test_same_chebi_but_more_chebi_in_one_entity(){
    ...
    @Test
    public void test_no_chebi_standard_inchi_key_null_after(){
    ...
    @Test
    public void test_no_chebi_standard_inchi_null_after(){
    ...
    @Test
    public void test_no_chebi_same_smile(){
    ...
    @Test
    public void test_no_chebi_smile_null_after(){
