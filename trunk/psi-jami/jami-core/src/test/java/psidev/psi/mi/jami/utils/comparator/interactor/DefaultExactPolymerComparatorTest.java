...
/**
 * Unit tester for DefaultExactPolymerComparator
 *
...
public class DefaultExactPolymerComparatorTest {

    private DefaultExactPolymerComparator comparator = new DefaultExactPolymerComparator();
    ...
    public void test_polymer_null_after(){
        ...
        Assert.assertFalse(DefaultExactPolymerComparator.areEquals(interactor1, interactor2));
    }
    ...
    public void test_interactor_properties_before_sequence(){
        ...
        interactor1.setInteractorType(CvTermUtils.createGeneInteractorType());
        Polymer interactor2 = new DefaultPolymer("test");
    ...
    public void test_same_interactor_properties_one_sequence_not_provided(){
        ...
        Assert.assertTrue(DefaultExactPolymerComparator.areEquals(interactor1, interactor2));
    }
