...
public class DefaultInteractorComparator extends InteractorComparator{
    ...
    @Override
    public DefaultPolymerComparator getPolymerComparator() {
        return (DefaultPolymerComparator) super.getPolymerComparator();
    }
    ...
    @Override
    public DefaultProteinComparator getProteinComparator() {
        return (DefaultProteinComparator) super.getProteinComparator();
    }
