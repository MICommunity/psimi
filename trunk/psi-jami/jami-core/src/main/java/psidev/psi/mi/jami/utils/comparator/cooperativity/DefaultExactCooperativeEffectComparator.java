...
public class DefaultExactCooperativeEffectComparator extends CooperativeEffectComparator {
    ...
    private static DefaultExactCooperativeEffectComparator defaultCooperativeEffectComparator;
    ...
    public static boolean areEquals(CooperativeEffect effect1, CooperativeEffect effect2){
        if (defaultCooperativeEffectComparator == null){
            defaultCooperativeEffectComparator = new DefaultExactCooperativeEffectComparator();
        }
