...
public class XmlParticipantCandidateWrapper implements ModelledParticipant {
    ...
    public XmlParticipantCandidateWrapper(ParticipantCandidate part, ModelledInteraction wrapper){
        if (part == null){
    ...
    public ModelledInteraction getInteraction() {
        if (this.parent == null &&
                this.participant.getParentPool() != null &&
                this.participant.getParentPool().getInteraction() instanceof ExtendedPsiXmlInteraction){
            this.parent = new XmlBasicInteractionComplexWrapper((ExtendedPsiXmlInteraction)this.participant.getParentPool().getInteraction());
        }
        return this.parent;
    }
