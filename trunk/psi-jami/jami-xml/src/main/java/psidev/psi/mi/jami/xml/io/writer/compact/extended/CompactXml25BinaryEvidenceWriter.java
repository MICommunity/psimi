...
public class CompactXml25BinaryEvidenceWriter extends AbstractCompactXml25Writer<BinaryInteractionEvidence>{
    ...
    protected void initialiseSubWriters() {
        ...
        PsiXmlElementWriter<FeatureEvidence> featureWriter = new XmlFeatureEvidenceWriter(getStreamWriter(), getElementCache(), aliasWriter,
        ...
        setInteractionWriter(new CompactXmlBinaryInteractionEvidenceWriter(getStreamWriter(), getElementCache(),
