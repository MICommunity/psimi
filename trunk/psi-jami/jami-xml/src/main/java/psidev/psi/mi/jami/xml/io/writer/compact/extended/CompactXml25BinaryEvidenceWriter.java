...
public class CompactXml25BinaryEvidenceWriter extends AbstractCompactXml25Writer<BinaryInteractionEvidence>{
    ...
    public CompactXml25BinaryEvidenceWriter(XMLStreamWriter streamWriter, PsiXmlObjectCache elementCache) {
    ...
    protected void initialiseSubWriters() {
        ...
        PsiXmlElementWriter<FeatureEvidence> featureWriter = new Xml25FeatureEvidenceWriter(getStreamWriter(), getElementCache(), aliasWriter,
