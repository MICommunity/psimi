...
public class Xml25ExperimentalRoleWriter extends AbstractXml25CvTermWriter {
    ...
    public Xml25ExperimentalRoleWriter(XMLStreamWriter writer, PsiXml25ElementWriter<Alias> aliasWriter, PsiXml25XrefWriter primaryRefWriter, PsiXml25XrefWriter secondaryRefWriter) {
