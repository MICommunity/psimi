...
public class Xml25CelltypeWriter extends AbstractXml25OpenCvTermWriter {
    public Xml25CelltypeWriter(XMLStreamWriter2 writer) {
        super(writer);
    }

    public Xml25CelltypeWriter(XMLStreamWriter2 writer, PsiXml25ElementWriter<Alias> aliasWriter,
