...
import psidev.psi.mi.jami.xml.io.writer.elements.impl.expanded.ExpandedXml25NamedInteractionWriter;
...
public class LightExpandedXml25NamedWriter extends AbstractExpandedXml25Writer<Interaction>{

    public LightExpandedXml25NamedWriter() {
        super(Interaction.class);
    }

    public LightExpandedXml25NamedWriter(File file) throws IOException, XMLStreamException {
        super(Interaction.class, file);
    }

    public LightExpandedXml25NamedWriter(OutputStream output) throws XMLStreamException {
        super(Interaction.class, output);
    }

    public LightExpandedXml25NamedWriter(Writer writer) throws XMLStreamException {
        super(Interaction.class, writer);
    }

    public LightExpandedXml25NamedWriter(XMLStreamWriter streamWriter, PsiXml25ObjectCache cache) {
    ...
    protected void initialiseSubWriters() {
        ...
        setInteractionWriter(new ExpandedXml25NamedInteractionWriter(getStreamWriter(), getElementCache(),
