...
public class XmlModelledParticipant extends AbstractXmlParticipant<ModelledInteraction, ModelledFeature> implements ModelledParticipant{
     ...
     */
    public static class JAXBAttributeList extends AbstractEntityAttributeList<XmlModelledParticipant> {
     ...
     */
    public static class JAXBFeatureList extends AbstractEntityFeatureList<ModelledFeature, XmlModelledParticipant> {
