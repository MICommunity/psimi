...
public abstract class AbstractExpandedXml25Writer<T extends Interaction> extends AbstractXmlWriter<T> {
    ...
    protected AbstractExpandedXml25Writer(Class<T> type, XMLStreamWriter streamWriter, PsiXmlObjectCache elementCache) {
