...
import psidev.psi.mi.jami.xml.io.writer.elements.impl.expanded.ExpandedXml25NamedInteractionEvidenceWriter;
...
public class ExpandedXml25NamedEvidenceWriter extends AbstractExpandedXml25Writer<InteractionEvidence>{

    public ExpandedXml25NamedEvidenceWriter() {
        super(InteractionEvidence.class);
    }

    public ExpandedXml25NamedEvidenceWriter(File file) throws IOException, XMLStreamException {
        super(InteractionEvidence.class, file);
    }

    public ExpandedXml25NamedEvidenceWriter(OutputStream output) throws XMLStreamException {
        super(InteractionEvidence.class, output);
    }

    public ExpandedXml25NamedEvidenceWriter(Writer writer) throws XMLStreamException {
        super(InteractionEvidence.class, writer);
    }

    public ExpandedXml25NamedEvidenceWriter(XMLStreamWriter streamWriter, PsiXml25ObjectCache cache) {
