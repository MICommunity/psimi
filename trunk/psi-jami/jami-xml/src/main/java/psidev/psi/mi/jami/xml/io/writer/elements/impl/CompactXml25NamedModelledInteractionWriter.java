...
public class CompactXml25NamedModelledInteractionWriter extends AbstractModelledInteractionWriter implements CompactPsiXml25ElementWriter<ModelledInteraction> {
    private PsiXml25ElementWriter<Alias> aliasWriter;

    public CompactXml25NamedModelledInteractionWriter(XMLStreamWriter2 writer, PsiXml25ObjectIndex objectIndex) {
