...
public class Xml25StartStatusWriter extends AbstractXml25CvTermWriter {
    ...
    public Xml25StartStatusWriter(XMLStreamWriter writer, PsiXml25ElementWriter<Alias> aliasWriter, PsiXml25XrefWriter primaryRefWriter, PsiXml25XrefWriter secondaryRefWriter) {
