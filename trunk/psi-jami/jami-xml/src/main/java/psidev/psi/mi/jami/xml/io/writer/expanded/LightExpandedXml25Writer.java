...
public class LightExpandedXml25Writer extends AbstractExpandedXml25Writer<Interaction>{
    ...
    public LightExpandedXml25Writer(XMLStreamWriter streamWriter, PsiXmlObjectCache cache) {
    ...
    protected void initialiseSubWriters() {
        ...
        PsiXmlParticipantWriter<Participant> participantWriter = new ExpandedXmlParticipantWriter(getStreamWriter(), getElementCache(),
        ...
        setInteractionWriter(new ExpandedXmlBasicInteractionWriter(getStreamWriter(), getElementCache(),
