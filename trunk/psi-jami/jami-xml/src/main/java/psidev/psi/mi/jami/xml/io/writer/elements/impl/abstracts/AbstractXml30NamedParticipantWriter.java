...
/**
 * Abstract class for a named participant XML 3.0 writer
 *
...
public abstract class AbstractXml30NamedParticipantWriter<P extends Participant, F extends Feature> extends AbstractXml30ParticipantWriter<P,F> {
    public AbstractXml30NamedParticipantWriter(XMLStreamWriter writer, PsiXmlObjectCache objectIndex) {
