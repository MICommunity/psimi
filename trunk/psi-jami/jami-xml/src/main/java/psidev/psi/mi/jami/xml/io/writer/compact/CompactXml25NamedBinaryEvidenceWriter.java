...
public class CompactXml25NamedBinaryEvidenceWriter extends AbstractCompactXml25Writer<BinaryInteractionEvidence>{
    ...
    public CompactXml25NamedBinaryEvidenceWriter(XMLStreamWriter streamWriter, PsiXmlObjectCache cache) {
    ...
    protected void initialiseSubWriters() {
        ...
        setInteractionWriter(new CompactXmlNamedBinaryInteractionEvidenceWriter(getStreamWriter(), getElementCache(),
