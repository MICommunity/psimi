...
import psidev.psi.mi.jami.xml.io.writer.elements.impl.compact.CompactXml25NamedParticipantEvidenceWriter;
...
public class CompactXml25NamedBinaryEvidenceWriter extends AbstractCompactXml25Writer<BinaryInteractionEvidence>{
    ...
    public CompactXml25NamedBinaryEvidenceWriter(XMLStreamWriter streamWriter, PsiXml25ObjectCache cache) {
    ...
    protected void initialiseSubWriters() {
        ...
        setInteractionWriter(new CompactXml25NamedBinaryInteractionEvidenceWriter(getStreamWriter(), getElementCache(),
