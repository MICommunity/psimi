...
public class ExpandedXml25BinaryEvidenceWriter extends AbstractExpandedXml25Writer<BinaryInteractionEvidence> {
    ...
    public ExpandedXml25BinaryEvidenceWriter(XMLStreamWriter streamWriter, PsiXmlObjectCache elementCache) {
    ...
    protected void initialiseSubWriters() {
        ...
        ExpandedPsiXmlElementWriter<ExperimentalInteractor> experimentalInteractorWriter = new ExpandedXml25ExperimentalInteractorWriter(getStreamWriter(), getElementCache());
        PsiXmlParticipantWriter<ParticipantEvidence> participantWriter = new ExpandedXml25ParticipantEvidenceWriter(getStreamWriter(), getElementCache(),
        ...
        PsiXmlExperimentWriter experimentWriter = new Xml25ExperimentWriter(getStreamWriter(), getElementCache(), aliasWriter,
