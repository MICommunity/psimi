...
import psidev.psi.mi.jami.xml.io.writer.elements.impl.extended.expanded.xml25.XmlBasicBinaryInteractionWriter;
...
/**
 * Unit tester for XmlBasicBinaryInteractionWriter
 *
...
public class ExpandedXmlBasicBinaryInteractionWriterTest extends AbstractXmlWriterTest {
    ...
    public void test_write_interaction_intraMolecular() throws XMLStreamException, IOException, IllegalRangeException {
        ExtendedPsiXmlInteraction interaction = new XmlBinaryInteraction();
        Participant participant = new DefaultParticipant(new DefaultProtein("protein test"));
        interaction.addParticipant(participant);
