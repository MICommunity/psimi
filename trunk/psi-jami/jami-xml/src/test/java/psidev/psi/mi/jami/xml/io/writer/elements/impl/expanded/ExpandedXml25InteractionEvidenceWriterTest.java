...
/**
 * Unit tester for CompactXml25InteractionEvidenceWriter
 *
...
public class ExpandedXml25InteractionEvidenceWriterTest extends AbstractXml25WriterTest {
    ...
    public void test_write_interaction() throws XMLStreamException, IOException, IllegalRangeException {
        ...
        ExpandedXml25InteractionEvidenceWriter writer = new ExpandedXml25InteractionEvidenceWriter(createStreamWriter(), this.elementCache);
    ...
    public void test_write_participant_complex_no_participants() throws XMLStreamException, IOException, IllegalRangeException {
        ...
        interaction.setExperiment(new DefaultExperiment(new DefaultPublication("xxxxxx")));
        ExpandedXml25InteractionEvidenceWriter writer = new ExpandedXml25InteractionEvidenceWriter(createStreamWriter(), this.elementCache);        writer.write(interaction);
        streamWriter.flush();
    ...
    public void test_write_interaction_shortName() throws XMLStreamException, IOException, IllegalRangeException {
        InteractionEvidence interaction = new DefaultInteractionEvidence("interaction test");
        ParticipantEvidence participant = new DefaultParticipantEvidence(new DefaultProtein("protein test"));
        interaction.addParticipant(participant);
        elementCache.clear();
