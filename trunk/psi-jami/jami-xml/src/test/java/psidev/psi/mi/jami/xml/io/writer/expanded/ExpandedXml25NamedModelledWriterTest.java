...
/**
 * Unit tester for ExpandedXml25NamedModelledWriter
 *
...
public class ExpandedXml25NamedModelledWriterTest {
    ...
    public void test_not_initialised_writer() {
        ExpandedXml25NamedModelledWriter writer = new ExpandedXml25NamedModelledWriter();
    ...
    public void test_single_interaction() throws XMLStreamException {
        ...
        ExpandedXml25NamedModelledWriter writer = new ExpandedXml25NamedModelledWriter(stringWriter);
    ...
    public void test_several_interactions1() throws XMLStreamException {
        ...
        ModelledParticipant participant = new DefaultNamedModelledParticipant(new DefaultProtein("protein test"));
        interaction.addParticipant(participant);
        ModelledInteraction interaction2 = new DefaultNamedModelledInteraction();
    ...
    public void test_interactions_different_sources() throws XMLStreamException {
        ...
        ModelledInteraction interaction3 = new DefaultNamedModelledInteraction();
        interaction3.addParticipant(participant);
        ModelledInteraction interaction4 = new DefaultNamedModelledInteraction();
