...
import psidev.psi.mi.jami.binary.impl.DefaultNamedBinaryInteraction;
...
import psidev.psi.mi.jami.xml.io.writer.elements.impl.expanded.xml25.XmlNamedBinaryInteractionWriter;

import javax.xml.stream.XMLStreamException;
import java.io.IOException;

/**
 * Unit tester for XmlNamedBinaryInteractionWriter
 *
...
public class ExpandedXml25NamedBinaryInteractionWriterTest extends AbstractXml25WriterTest {
    ...
    public void test_write_interaction() throws XMLStreamException, IOException, IllegalRangeException {
        ...
        XmlNamedBinaryInteractionWriter writer = new XmlNamedBinaryInteractionWriter(createStreamWriter(), this.elementCache);
    ...
    public void test_write_interaction_xref() throws XMLStreamException, IOException, IllegalRangeException {
        BinaryInteraction interaction = new DefaultNamedBinaryInteraction();        Participant participant = new DefaultParticipant(new DefaultProtein("protein test"));
        interaction.addParticipant(participant);
