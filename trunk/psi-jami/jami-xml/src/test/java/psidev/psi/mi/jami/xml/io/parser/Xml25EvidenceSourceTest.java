...
public class Xml25EvidenceSourceTest {
    ...
    public void validate_valid_file(){
        ...
        options.put(MIDataSourceFactory.INPUT_OPTION_KEY, Xml25EvidenceSourceTest.class.getResourceAsStream("/samples/21703451.xml"));
    ...
    public void validate_invalid_file(){
        ...
        dataSource = new Xml25EvidenceSource();
        Map<String, Object> options = new HashMap<String, Object>();
        options.put(MIDataSourceFactory.INPUT_OPTION_KEY, Xml25EvidenceSourceTest.class.getResourceAsStream("/samples/empty.xml"));
        dataSource.initialiseContext(options);
        Assert.assertFalse(dataSource.validateSyntax());
        dataSource.close();
    }
    ...
    public void parse_valid_file() throws IOException {
        ...
        dataSource = new Xml25EvidenceSource();
        Map<String, Object> options = new HashMap<String, Object>();
        options.put(MIDataSourceFactory.INPUT_OPTION_KEY, new File(Xml25EvidenceSourceTest.class.getResource("/samples/10049915.xml").getFile()));
        dataSource.initialiseContext(options);
    ...
    public void iterate_invalid_file(){
        ...
        dataSource = new Xml25EvidenceSource();
        Map<String, Object> options = new HashMap<String, Object>();
        options.put(MIDataSourceFactory.INPUT_OPTION_KEY, new File(Xml25EvidenceSourceTest.class.getResource("/samples/empty.xml").getFile()));
        dataSource.initialiseContext(options);
        iterator = dataSource.getInteractionsIterator();
        Assert.assertFalse(iterator.hasNext());
        Assert.assertFalse(dataSource.validateSyntax());
