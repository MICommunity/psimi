...
import psidev.psi.mi.jami.enricher.impl.full.FullBioactiveEntityUpdater;
 ...
 * @since 09/08/13
 */
public class FullBioactiveEntityUpdaterTest {
    ...
    public void test_enriching_with_null_CvTermFetcher() throws EnricherException {
        ...
        enricher = new FullBioactiveEntityUpdater(null);
    }
