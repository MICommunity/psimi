...
public class MitabDocumentDefinitionFactory {
    ...
    public static ColumnBasedDocumentDefinition mitab27() {
        ...
        ColumnDefinition ftypeB = new ColumnDefinitionBuilder()
                ...
                .setName("Feature(s) for interactor B")
    ...
    public static ColumnBasedDocumentDefinition mitab28() {

        XrefFieldParser xrefParser = new XrefFieldParser();
        XrefFieldFormatter xrefFormatter = new XrefFieldFormatter();

        ColumnDefinition biologicalEffectA = new ColumnDefinitionBuilder()
                .setName("Biological Effect Interactor A")
                .setKey(Mitab28ColumnKeys.KEY_BIO_EFFECT_A)
                .setFieldSeparator("|")
                .setEmptyValue("-")
                .setFieldDelimiter("")
                .setIsAllowsEmpty(true)
        ...
        ColumnDefinition biologicalEffectB = new ColumnDefinitionBuilder()
                .extendColumnDefinition(biologicalEffectA)
                .setName("Biological Effect Interactor B")
                .setKey(Mitab28ColumnKeys.KEY_BIO_EFFECT_B)
                .setPosition(43)
                .build();

        ColumnDefinition causalRegulatoryMechanism = new ColumnDefinitionBuilder()
                .extendColumnDefinition(biologicalEffectA)
                .setName("Causal Regulatory Mechanism")
                .setKey(Mitab28ColumnKeys.KEY_CAUSAL_REG_MECHANISM)
                .setPosition(44)
                .build();

        ColumnDefinition causalStatement = new ColumnDefinitionBuilder()
                .extendColumnDefinition(biologicalEffectA)
                .setName("Causal Statement")
                .setKey(Mitab28ColumnKeys.KEY_CAUSAL_STAT)
                .setPosition(45)
                .build();

        ColumnBasedDocumentDefinition docDefinition = new ColumnBasedDocumentDefinitionBuilder()
                .extendDocumentDefinition(mitab27())
                .setName("mitab28")
                .setDefinition("MITAB28 Specification")
                .addColumnDefinition(biologicalEffectA)
                .addColumnDefinition(biologicalEffectB)
                .addColumnDefinition(causalRegulatoryMechanism)
                .addColumnDefinition(causalStatement)
                .build();
