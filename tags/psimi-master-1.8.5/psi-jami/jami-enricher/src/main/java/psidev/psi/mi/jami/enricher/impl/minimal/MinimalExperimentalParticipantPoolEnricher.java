 ...
 * @since 19/06/13
 */
public class MinimalExperimentalParticipantPoolEnricher
        extends MinimalParticipantEvidenceEnricher<ExperimentalParticipantPool> implements ExperimentalParticipantPoolEnricher {
    ...
    protected void processParticipantCandidates(ExperimentalParticipantPool objectToEnrich, ExperimentalParticipantPool objectSource) throws EnricherException {
        EnricherUtils.mergeParticipantCandidates(objectToEnrich, objectToEnrich, objectSource, false,
