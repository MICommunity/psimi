...
public class ExperimentalInteractorConverter {
    ...
    public psidev.psi.mi.xml.model.ExperimentalInteractor fromJaxb( psidev.psi.mi.xml253.jaxb.ParticipantType.ExperimentalInteractorList.ExperimentalInteractor jExperimentalInteractor ) throws ConverterException {
    ...
    public psidev.psi.mi.xml253.jaxb.ParticipantType.ExperimentalInteractorList.ExperimentalInteractor toJaxb( psidev.psi.mi.xml.model.ExperimentalInteractor mExperimentalInteractor ) throws ConverterException {
        ...
        psidev.psi.mi.xml253.jaxb.ParticipantType.ExperimentalInteractorList.ExperimentalInteractor jExperimentalInteractor = new psidev.psi.mi.xml253.jaxb.ParticipantType.ExperimentalInteractorList.ExperimentalInteractor();
        ...
        if ( mExperimentalInteractor.hasExperiments() ) {
            if ( jExperimentalInteractor.getExperimentRefList() == null ) {
                jExperimentalInteractor.setExperimentRefList( new ExperimentRefListType() );
            }
