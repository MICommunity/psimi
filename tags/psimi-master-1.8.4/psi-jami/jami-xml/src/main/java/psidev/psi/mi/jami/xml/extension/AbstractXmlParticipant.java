 ...
 */
@XmlTransient
public class AbstractXmlParticipant <I extends Interaction, F extends Feature> implements Participant<I,F>, FileSourceContext {
    ...
    private XmlInteractor molecule;
    ...
    public Integer getInteractionRef() {
        // todo deals with interactions ref
     ...
     *
     */
    public XmlInteractor getInteractorDescription() {
        // todo deals with interactions ref
        return molecule;
    }
     ...
     *
     */
    public void setInteractorDescription(XmlInteractor value) {
        // todo deals with interactions ref
        this.molecule = value;
    }
     ...
     *
     */
    public void setFeatureList(ArrayList<F> value) {
        getFeatures().clear();
