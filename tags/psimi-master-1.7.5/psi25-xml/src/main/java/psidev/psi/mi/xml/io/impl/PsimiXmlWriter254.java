...
public class PsimiXmlWriter254 implements PsimiXmlWriter {
    ...
    private void marshall( psidev.psi.mi.xml254.jaxb.EntrySet jEntrySet, OutputStream os ) throws PsimiXmlWriterException {
    ...
    private void marshall( psidev.psi.mi.xml254.jaxb.EntrySet jEntrySet, Writer writer ) throws PsimiXmlWriterException {
    ...
    private void marshall( psidev.psi.mi.xml254.jaxb.EntrySet jEntrySet, File file ) throws PsimiXmlWriterException {
        try {
            // create a marshaller
            Marshaller m = getMarshaller( jEntrySet );
    ...
    private psidev.psi.mi.xml254.jaxb.EntrySet convertInMemory( EntrySet mEntrySet ) throws PsimiXmlWriterException {
        ...
        try {
            // convert JAXB model
            psidev.psi.mi.xml254.jaxb.EntrySet jEntrySet = converter.toJaxb( mEntrySet );
    ...
    public void write( EntrySet mEntrySet, File file ) throws PsimiXmlWriterException {
        ...
        psidev.psi.mi.xml254.jaxb.EntrySet jEntrySet = convertInMemory( mEntrySet );
