 ...
 * @see psidev.psi.mi.xml254.jaxb.InferredInteraction
...
public class InferredInteractionConverter {
    ...
    public psidev.psi.mi.xml.model.InferredInteraction fromJaxb( psidev.psi.mi.xml254.jaxb.InferredInteraction jInferredInteraction ) throws ConverterException {
        ...
        // participants
        for ( psidev.psi.mi.xml254.jaxb.InferredInteractionParticipant jParticipant :
    ...
    public psidev.psi.mi.xml254.jaxb.InferredInteraction
    toJaxb( psidev.psi.mi.xml.model.InferredInteraction mInferredInteraction ) throws ConverterException {
        ...
        psidev.psi.mi.xml254.jaxb.InferredInteraction jInferredInteraction =
                new psidev.psi.mi.xml254.jaxb.InferredInteraction();
        ...
        if ( mInferredInteraction.hasExperiments() ) {
            if ( jInferredInteraction.getExperimentRefList() == null ) {
                jInferredInteraction.setExperimentRefList( new ExperimentRefList() );
            }
