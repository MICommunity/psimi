...
/**
 * Unit tester for UnambiguousPublicationComparator
 *
...
public class UnambiguousPublicationComparatorTest {

    private UnambiguousPublicationComparator comparator = new UnambiguousPublicationComparator();
    ...
    public void test_publication_null_after() throws Exception {
        ...
        Assert.assertFalse(UnambiguousPublicationComparator.areEquals(pub1, pub2));
        Assert.assertTrue(UnambiguousPublicationComparator.hashCode(pub1) != UnambiguousPublicationComparator.hashCode(pub2));
    }
    ...
    public void test_same_imexid() throws Exception {
        ...
        Assert.assertTrue(UnambiguousPublicationComparator.areEquals(pub1, pub2));
        Assert.assertTrue(UnambiguousPublicationComparator.hashCode(pub1) == UnambiguousPublicationComparator.hashCode(pub2));
    }
    ...
    @Test
    public void test_at_least_one_identifier_not_equal() throws Exception {
        Publication pub1 = new DefaultPublication();
    ...
    @Test
    public void test_same_identifiers() throws Exception {
        Publication pub1 = new DefaultPublication();
        pub1.getIdentifiers().add(XrefUtils.createXref("test", "TEST-1"));
