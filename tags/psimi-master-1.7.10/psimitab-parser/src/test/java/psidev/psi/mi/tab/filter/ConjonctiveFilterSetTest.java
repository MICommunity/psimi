 ...
 * @since 1.0-beta4
 */
public class ConjonctiveFilterSetTest extends AbstractFilterTest {

    @Test
    public void Evaluate_errors() {

        try {
            new ConjonctiveFilterSet( null );
            fail();
        } catch ( Exception e ) {
            // ok
        }
        ...
        try {
            ConjonctiveFilterSet set = new ConjonctiveFilterSet( filters );
            fail();
        } catch ( Exception e ) {
            // ok
        }
    ...
    public void Evaluate_manyFilters() {
        ...
        set = new ConjonctiveFilterSet( filters );
