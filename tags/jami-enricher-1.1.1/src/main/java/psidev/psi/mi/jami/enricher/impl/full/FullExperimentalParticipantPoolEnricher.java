 ...
 * @since 19/06/13
 */
public class FullExperimentalParticipantPoolEnricher
        extends FullParticipantEvidenceEnricher<ExperimentalParticipantPool> implements ExperimentalParticipantPoolEnricher {
