...
/**
 * Unit tester for DefaultExtendedMitab26ColumnFeeder
 *
...
public class DefaultExtendedMitab26ColumnFeederTest {

    @Test(expected = ClassCastException.class)
    public void write_aliases_no_mitab() throws IOException {
        StringWriter writer = new StringWriter();
        DefaultExtendedMitab26ColumnFeeder feeder = new DefaultExtendedMitab26ColumnFeeder(writer);
        ...
        feeder = new DefaultExtendedMitab26ColumnFeeder(writer);
