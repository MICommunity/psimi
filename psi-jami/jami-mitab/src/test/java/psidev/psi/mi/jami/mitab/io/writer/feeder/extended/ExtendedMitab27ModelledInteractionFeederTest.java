...
import psidev.psi.mi.jami.tab.io.writer.feeder.extended.ExtendedMitab27ModelledInteractionFeeder;
...
public class ExtendedMitab27ModelledInteractionFeederTest {

    @Test(expected = ClassCastException.class)
    public void write_aliases_no_mitab() throws IOException {
        StringWriter writer = new StringWriter();
        ExtendedMitab27ModelledInteractionFeeder feeder = new ExtendedMitab27ModelledInteractionFeeder(writer);
        ...
        feeder = new ExtendedMitab27ModelledInteractionFeeder(writer);
