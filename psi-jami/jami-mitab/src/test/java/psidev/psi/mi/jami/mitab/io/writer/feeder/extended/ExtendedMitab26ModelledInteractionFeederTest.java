...
/**
 * Unit tester for ExtendedMitab26ModelledInteractionFeeder
 *
...
public class ExtendedMitab26ModelledInteractionFeederTest {

    @Test(expected = ClassCastException.class)
    public void write_aliases_no_mitab() throws IOException {
        StringWriter writer = new StringWriter();
        ExtendedMitab26ModelledInteractionFeeder feeder = new ExtendedMitab26ModelledInteractionFeeder(writer);
        ...
        feeder = new ExtendedMitab26ModelledInteractionFeeder(writer);
