...
import psidev.psi.mi.jami.tab.io.writer.LightMitab26Writer;
...
/**
 * Unit tester for LightMitab26Writer
 *
...
public class LightMitab26WriterTest {

    @Test
    public void test_mitab_version_and_header(){
        LightMitab26Writer binaryWriter = new LightMitab26Writer();
    ...
    public void test_write_interaction() throws IllegalParameterException, ParseException {
        ...
        LightMitab26Writer interactionWriter = new LightMitab26Writer(writer);
    ...
    public void test_write_binary_list() throws IllegalParameterException, ParseException {
        StringWriter writer = new StringWriter();
        LightMitab26Writer binaryWriter = new LightMitab26Writer(writer);
