...
import psidev.psi.mi.jami.tab.io.writer.LightMitab25BinaryWriter;
...
/**
 * Unit tester for LightMitab25BinaryWriter
 *
...
public class LightMitab25BinaryWriterTest {

    @Test
    public void test_mitab_version_and_header(){
        LightMitab25BinaryWriter binaryWriter = new LightMitab25BinaryWriter();
    ...
    public void test_write_binary() {
        ...
        LightMitab25BinaryWriter binaryWriter = new LightMitab25BinaryWriter(writer);
