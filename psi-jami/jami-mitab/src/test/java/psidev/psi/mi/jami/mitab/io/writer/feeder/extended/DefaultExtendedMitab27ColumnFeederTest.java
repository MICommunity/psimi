...
/**
 * Unit tester for DefaultExtendedMitab27ColumnFeeder
 *
...
public class DefaultExtendedMitab27ColumnFeederTest {

    @Test(expected = ClassCastException.class)
    public void write_aliases_no_mitab() throws IOException {
        StringWriter writer = new StringWriter();
        DefaultExtendedMitab27ColumnFeeder feeder = new DefaultExtendedMitab27ColumnFeeder(writer);
        ...
        feeder = new DefaultExtendedMitab27ColumnFeeder(writer);
