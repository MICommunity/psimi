...
public class Mitab25BinaryWriterTest {
    ...
    public void test_write_binary_list() throws DataSourceWriterException, ParseException {
        ...
        // add aliases
        participantA2.getInteractor().getAliases().add(new MitabAlias("mint", "brca2", "gene name"));
        participantA2.getInteractor().getAliases().add(new MitabAlias("intact", "brca2 synonym", "gene name synonym"));
        participantA2.getAliases().add(new MitabAlias("intact", "\"bla\" author assigned name", "author assigned name"));
        // species
        ...
        // confidences
        binary2.getConfidences().add(new MitabConfidence("author-score", "high", "text"));
