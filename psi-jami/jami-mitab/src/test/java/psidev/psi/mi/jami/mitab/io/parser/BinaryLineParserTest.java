...
/**
 * Unit tester for InteractionLineParser
 *
...
public class BinaryLineParserTest {
    ...
    public void test_read_valid_mitab25() throws ParseException, java.text.ParseException {
        ...
        BinaryLineParser parser = new BinaryLineParser(stream);

        // read first interaction
        BinaryInteraction binary = (BinaryInteraction)parser.MitabLine();
    ...
    public void test_read_valid_mitab27() throws ParseException, java.text.ParseException {
        ...
        Interaction binary2 = parser.MitabLine();
        Assert.assertNotNull(binary2);
        Participant A2 = (Participant)binary2.getParticipants().iterator().next();
    ...
    public void test_header_and_empty_lines() throws ParseException, java.text.ParseException {
        ...
        // read first interaction
        BinaryInteraction title = (BinaryInteraction)parser.MitabLine();
        Assert.assertNull(title);
        Assert.assertFalse(parser.hasFinished());

        // read title
        Interaction empty_line1 = parser.MitabLine();
        ...
        // read title
        Interaction empty_line2 = parser.MitabLine();
        Assert.assertNull(empty_line2);
        Assert.assertFalse(parser.hasFinished());

        // read title
        Interaction line2 = parser.MitabLine();
    ...
    public void test_syntax_error_unique_identifier() throws ParseException, java.text.ParseException {
        ...
        // read first interaction
        BinaryInteraction<Participant> line1 = parser.MitabLine();
        Assert.assertNotNull(line1);
