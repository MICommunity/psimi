...
/**
 * Unit tester for DefaultMitab27ColumnFeeder
 *
...
public class DefaultMitab27ColumnFeederTest {

    @Test
    public void write_feature() throws IOException {
        StringWriter writer = new StringWriter();
        DefaultMitab27ColumnFeeder feeder = new DefaultMitab27ColumnFeeder(writer);
        ...
        feeder = new DefaultMitab27ColumnFeeder(writer);
