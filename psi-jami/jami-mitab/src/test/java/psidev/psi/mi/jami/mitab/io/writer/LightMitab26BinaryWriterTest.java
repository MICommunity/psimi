...
import psidev.psi.mi.jami.tab.io.writer.LightMitab26BinaryWriter;
...
/**
 * Unit tester for LightMitab26BinaryWriter
 *
...
public class LightMitab26BinaryWriterTest {

    @Test
    public void test_mitab_version_and_header(){
        LightMitab26BinaryWriter binaryWriter = new LightMitab26BinaryWriter();
    ...
    public void test_write_binary() throws IllegalParameterException, ParseException {
        ...
        LightMitab26BinaryWriter binaryWriter = new LightMitab26BinaryWriter(writer);
