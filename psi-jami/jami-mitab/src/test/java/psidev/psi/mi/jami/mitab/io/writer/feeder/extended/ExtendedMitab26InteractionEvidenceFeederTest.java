...
import psidev.psi.mi.jami.tab.io.writer.feeder.extended.ExtendedMitab26InteractionEvidenceFeeder;
...
/**
 * Unit tester for ExtendedMitab26InteractionEvidenceFeeder
 *
...
public class ExtendedMitab26InteractionEvidenceFeederTest {

    @Test(expected = ClassCastException.class)
    public void write_aliases_no_mitab() throws IOException {
        StringWriter writer = new StringWriter();
        ExtendedMitab26InteractionEvidenceFeeder feeder = new ExtendedMitab26InteractionEvidenceFeeder(writer);
        ...
        feeder = new ExtendedMitab26InteractionEvidenceFeeder(writer);
