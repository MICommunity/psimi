...
public class ExtendedMitab25InteractionEvidenceFeeder extends Mitab25InteractionEvidenceFeeder {
    public ExtendedMitab25InteractionEvidenceFeeder(Writer writer) {
        super(writer);
    }
