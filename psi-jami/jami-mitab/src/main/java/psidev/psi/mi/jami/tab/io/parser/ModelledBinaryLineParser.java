...
public class ModelledBinaryLineParser extends ModelledInteractionLineParser {
    ...
    @Override
    protected void initialiseExpansionMethod(Collection<MitabCvTerm> expansion, ModelledInteraction interaction) {
        ModelledBinaryInteraction binary = (ModelledBinaryInteraction)interaction;
        if (expansion.size() > 1){
