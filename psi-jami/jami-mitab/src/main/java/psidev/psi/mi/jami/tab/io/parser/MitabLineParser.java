...
public abstract class MitabLineParser<T extends BinaryInteraction, P extends Participant> implements MitabLineParserConstants {
        ...
        void processSyntaxError(int lineNumber, int columnNumber, int mitabColumn, Exception e, boolean isRange) {
            fireOnInvalidSyntax(lineNumber, columnNumber, mitabColumn, isRange, e);
        }
    ...
    abstract void fireOnInvalidSyntax(int lineNumber, int columnNumber, int mitabColumn, boolean isRange, Exception e);
  ...
  int columnB;
    try {
      ...
      default:
        ...
        processSyntaxError(token.beginLine, token.beginColumn, 0, e, false);
  ...
  EnumSet<TokenKind> enumSet = EnumSet.of(TokenKind.FIELD_SEPARATOR, TokenKind.LINE_SEPARATOR, TokenKind.COLUMN_SEPARATOR);
    try {
      ...
      if (name == null){cv = new MitabCvTerm(MitabUtils.UNKNOWN_DATABASE, null, db, id); getParserListener().onMissingCvTermName(cv, beginLine, beginColumn, 16);}
      else if (id == null) {cv = new MitabCvTerm(name); getParserListener().onMissingExpansionId(cv, beginLine, beginColumn, 16);}
 ...
 java.lang.String text = null;
  ...
  EnumSet<TokenKind> enumSet = EnumSet.of(TokenKind.FIELD_SEPARATOR, TokenKind.LINE_SEPARATOR, TokenKind.COLUMN_SEPARATOR);
    try {
      ...
      else {conf = new MitabConfidence(type, value, text); getParserListener().onTextFoundInConfidence(conf, beginLine, beginColumn, 15);}
  ...
  EnumSet<TokenKind> enumSet = EnumSet.of(TokenKind.FIELD_SEPARATOR, TokenKind.LINE_SEPARATOR, TokenKind.COLUMN_SEPARATOR);
    try {
      ...
      if (recognizeImexPrimary && Xref.IMEX.equalsIgnoreCase(db.trim())){
         ...
         else if (qualifier != null) {ref = new MitabXref(db, id, text); getParserListener().onTextFoundInIdentifier(ref, beginLine, beginColumn, columnNumber);}
         ...
         ref = new MitabXref(db, id, qualifier);
          ...
          ref = new MitabXref(db, id, text); getParserListener().onTextFoundInIdentifier(ref, beginLine, beginColumn, columnNumber);
       }
       else{
          ref = new MitabXref(db, id, text);
       }
 ...
 java.lang.String text;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x78,0x38,0x800a0,0x800a0,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x800a0,0x38,0x38,0x38,0x38,0x38,0x38,0x120,0x38,0x38,0x420,0x420,0x38,0x38,0x2000,0x2000,0x838,0x838,0x4001,0x1000,0x1000,0x1000,0x1000,0x1000,0x1000,0x1000,0x1000,0x1000,0x1000,0x1000,0x1000,0x1000,0x1000,0x20,0x8000,0x18,0x20000,0x10000,0x20000,0x20000,0x20000,0x20000,0x80000,0x80000,0x20000,0x18,0x80000,0x80000,0x18,0x20040,0x20040,0x58,0x20000,0x20000,0x20000,0x18,};
   }
