...
public class ExpandedXml25ModelledParticipantWriter extends AbstractXml25ParticipantWriter<ModelledParticipant, ModelledFeature> implements ExpandedPsiXml25ElementWriter<ModelledParticipant> {
    public ExpandedXml25ModelledParticipantWriter(XMLStreamWriter writer, PsiXml25ObjectCache objectIndex) {
        super(writer, objectIndex, new Xml25ModelledFeatureWriter(writer, objectIndex));
    }

    public ExpandedXml25ModelledParticipantWriter(XMLStreamWriter writer, PsiXml25ObjectCache objectIndex, PsiXml25ElementWriter<Alias> aliasWriter, PsiXml25XrefWriter primaryRefWriter, PsiXml25XrefWriter secondaryRefWriter, PsiXml25ElementWriter<CvTerm> biologicalRoleWriter, PsiXml25ElementWriter<ModelledFeature> featureWriter, PsiXml25ElementWriter<Annotation> attributeWriter, PsiXml25ElementWriter<Interactor> interactorWriter) {
