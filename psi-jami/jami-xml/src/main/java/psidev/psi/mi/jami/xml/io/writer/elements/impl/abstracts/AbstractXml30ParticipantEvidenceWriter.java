...
public abstract class AbstractXml30ParticipantEvidenceWriter extends AbstractXml30ParticipantWriter<ParticipantEvidence, FeatureEvidence> {
    ...
    public AbstractXml30ParticipantEvidenceWriter(XMLStreamWriter writer, PsiXmlObjectCache objectIndex) {
