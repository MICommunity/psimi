...
public class CompactXml25ParticipantEvidenceWriter extends AbstractXmlParticipantEvidenceWriter implements CompactPsiXmlElementWriter<ParticipantEvidence> {
    private CompactPsiXmlElementWriter<ExperimentalInteractor> experimentalInteractorWriter;

    public CompactXml25ParticipantEvidenceWriter(XMLStreamWriter writer, PsiXmlObjectCache objectIndex) {
