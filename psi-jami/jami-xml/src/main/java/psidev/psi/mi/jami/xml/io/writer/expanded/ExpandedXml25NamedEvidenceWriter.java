...
public class ExpandedXml25NamedEvidenceWriter extends AbstractExpandedXml25Writer<InteractionEvidence>{
    ...
    public ExpandedXml25NamedEvidenceWriter(XMLStreamWriter streamWriter, PsiXmlObjectCache cache) {
    ...
    protected void initialiseSubWriters() {
        ...
        setInteractionWriter(new ExpandedXmlNamedInteractionEvidenceWriter(getStreamWriter(), getElementCache(),
