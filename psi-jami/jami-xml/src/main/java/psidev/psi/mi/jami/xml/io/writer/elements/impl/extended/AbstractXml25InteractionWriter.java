...
public abstract class AbstractXml25InteractionWriter<I extends Interaction, P extends Participant> extends AbstractXmlNamedInteractionWriter<I,P> implements PsiXmlExtendedInteractionWriter<I> {

    private PsiXmlElementWriter<InferredInteraction> inferredInteractionWriter;

    public AbstractXml25InteractionWriter(XMLStreamWriter writer, PsiXmlObjectCache objectIndex, PsiXmlParticipantWriter<P> participantWriter) {
    ...
    public AbstractXml25InteractionWriter(XMLStreamWriter writer, PsiXmlObjectCache objectIndex,
        ...
        super(writer, objectIndex, aliasWriter, primaryRefWriter, secondaryRefWriter, experimentWriter,
                participantWriter, new XmlInferredInteractionWriter(writer, objectIndex), interactionTypeWriter, attributeWriter,
                checksumWriter);
