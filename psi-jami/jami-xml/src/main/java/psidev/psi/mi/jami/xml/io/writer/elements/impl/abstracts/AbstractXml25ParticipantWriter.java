...
public abstract class AbstractXml25ParticipantWriter<P extends Participant, F extends Feature>
        extends  AbstractXmlParticipantWriter<P,F>{

    public AbstractXml25ParticipantWriter(XMLStreamWriter writer, PsiXmlObjectCache objectIndex){
