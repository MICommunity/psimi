...
public class CompactXml25NamedInteractionWriter extends AbstractXml25InteractionWithoutExperimentWriter<Interaction,Participant> implements CompactPsiXml25ElementWriter<Interaction> {
    private PsiXml25ElementWriter<Alias> aliasWriter;

    public CompactXml25NamedInteractionWriter(XMLStreamWriter2 writer, PsiXml25ObjectIndex objectIndex) {
