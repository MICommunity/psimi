...
public class Xml25BiologicalRoleWriter extends AbstractXml25CvTermWriter {
    public Xml25BiologicalRoleWriter(XMLStreamWriter2 writer) {
        super(writer);
    }

    public Xml25BiologicalRoleWriter(XMLStreamWriter2 writer, PsiXml25ElementWriter<Alias> aliasWriter, PsiXml25XrefWriter primaryRefWriter, PsiXml25XrefWriter secondaryRefWriter) {
