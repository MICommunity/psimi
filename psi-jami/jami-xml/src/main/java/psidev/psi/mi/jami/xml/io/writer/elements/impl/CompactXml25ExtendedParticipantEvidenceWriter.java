...
public class CompactXml25ExtendedParticipantEvidenceWriter extends AbstractXml25ParticipantEvidenceWriter implements CompactPsiXml25ElementWriter<ParticipantEvidence> {
    private CompactPsiXml25ElementWriter<ExperimentalInteractor> experimentalInteractorWriter;

    public CompactXml25ExtendedParticipantEvidenceWriter(XMLStreamWriter2 writer, PsiXml25ObjectIndex objectIndex) {
    ...
    public CompactXml25ExtendedParticipantEvidenceWriter(XMLStreamWriter2 writer, PsiXml25ObjectIndex objectIndex,
                                                         ...
                                                         PsiXml25ElementWriter<Interactor> interactorWriter, CompactPsiXml25ElementWriter<ExperimentalInteractor> experimentalInteractorWriter) {
