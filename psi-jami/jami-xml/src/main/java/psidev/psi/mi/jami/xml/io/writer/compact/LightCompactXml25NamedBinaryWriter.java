...
import psidev.psi.mi.jami.xml.io.writer.elements.impl.compact.CompactXmlNamedBinaryInteractionWriter;
...
public class LightCompactXml25NamedBinaryWriter extends AbstractCompactXml25Writer<BinaryInteraction>{
    ...
    public LightCompactXml25NamedBinaryWriter(XMLStreamWriter streamWriter, PsiXmlObjectCache cache) {
    ...
    protected void initialiseSubWriters() {
        ...
        setInteractionWriter(new CompactXmlNamedBinaryInteractionWriter(getStreamWriter(), getElementCache(),
