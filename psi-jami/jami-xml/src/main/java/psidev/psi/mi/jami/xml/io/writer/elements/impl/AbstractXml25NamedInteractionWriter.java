...
public abstract class AbstractXml25NamedInteractionWriter <I extends Interaction, P extends Participant> extends psidev.psi.mi.jami.xml.io.writer.elements.impl.AbstractXml25InteractionWriter<I,P> {

    private PsiXml25ElementWriter<Alias> aliasWriter;

    public AbstractXml25NamedInteractionWriter(XMLStreamWriter2 writer, PsiXml25ObjectIndex objectIndex, PsiXml25ElementWriter<P> participantWriter) {
        super(writer, objectIndex, participantWriter);
        this.aliasWriter = new Xml25AliasWriter(writer);
    }

    protected AbstractXml25NamedInteractionWriter(XMLStreamWriter2 writer, PsiXml25ObjectIndex objectIndex, PsiXml25XrefWriter primaryRefWriter, PsiXml25XrefWriter secondaryRefWriter, PsiXml25ElementWriter<P> participantWriter, PsiXml25ElementWriter<CvTerm> interactionTypeWriter, PsiXml25ElementWriter<Annotation> attributeWriter,
