...
public class ExpandedXmlNamedModelledBinaryInteractionWriter extends AbstractXmlModelledInteractionWriter<ModelledBinaryInteraction, ModelledParticipant> implements ExpandedPsiXmlElementWriter<ModelledBinaryInteraction> {
    private PsiXmlElementWriter<Alias> aliasWriter;

    public ExpandedXmlNamedModelledBinaryInteractionWriter(XMLStreamWriter writer, PsiXmlObjectCache objectIndex) {
