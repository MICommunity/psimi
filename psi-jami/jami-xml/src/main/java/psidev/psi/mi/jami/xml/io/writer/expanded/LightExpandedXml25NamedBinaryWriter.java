...
public class LightExpandedXml25NamedBinaryWriter extends AbstractExpandedXml25Writer<BinaryInteraction>{
    ...
    public LightExpandedXml25NamedBinaryWriter(XMLStreamWriter streamWriter, PsiXmlObjectCache cache) {
    ...
    protected void initialiseSubWriters() {
        ...
        setInteractionWriter(new ExpandedXmlNamedBinaryInteractionWriter(getStreamWriter(), getElementCache(),
