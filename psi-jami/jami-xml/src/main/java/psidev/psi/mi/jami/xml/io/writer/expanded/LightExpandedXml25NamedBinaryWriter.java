...
import psidev.psi.mi.jami.xml.io.writer.elements.impl.expanded.ExpandedXml25NamedBinaryInteractionWriter;
...
public class LightExpandedXml25NamedBinaryWriter extends AbstractExpandedXml25Writer<BinaryInteraction>{

    public LightExpandedXml25NamedBinaryWriter() {
        super(BinaryInteraction.class);
    }

    public LightExpandedXml25NamedBinaryWriter(File file) throws IOException, XMLStreamException {
        super(BinaryInteraction.class, file);
    }

    public LightExpandedXml25NamedBinaryWriter(OutputStream output) throws XMLStreamException {
        super(BinaryInteraction.class, output);
    }

    public LightExpandedXml25NamedBinaryWriter(Writer writer) throws XMLStreamException {
        super(BinaryInteraction.class, writer);
    }

    public LightExpandedXml25NamedBinaryWriter(XMLStreamWriter streamWriter, PsiXml25ObjectCache cache) {
    ...
    protected void initialiseSubWriters() {
        ...
        PsiXml25ParticipantWriter<Participant> participantWriter = new ExpandedXml25NamedParticipantWriter(getStreamWriter(), getElementCache(),
                ...
                interactorWriter, bioRoleWriter, featureWriter, attributeWriter);
        ...
        setInteractionWriter(new ExpandedXml25NamedBinaryInteractionWriter(getStreamWriter(), getElementCache(),
                aliasWriter, primaryRefWriter, secondaryRefWriter, experimentWriter, participantWriter,
