...
import psidev.psi.mi.jami.xml.io.writer.elements.impl.expanded.ExpandedXmlNamedModelledBinaryInteractionWriter;
...
public class ExpandedXml25NamedModelledBinaryWriter extends AbstractExpandedXml25Writer<ModelledBinaryInteraction>{
    ...
    public ExpandedXml25NamedModelledBinaryWriter(XMLStreamWriter streamWriter, PsiXmlObjectCache cache) {
    ...
    protected void initialiseSubWriters() {
        ...
        setInteractionWriter(new ExpandedXmlNamedModelledBinaryInteractionWriter(getStreamWriter(), getElementCache(),
                aliasWriter, primaryRefWriter, secondaryRefWriter, experimentWriter,
                modelledParticipantWriter, inferredInteractionWriter, interactionTypeWriter,
                confidenceWriter, parameterWriter, attributeWriter,
                checksumWriter));
