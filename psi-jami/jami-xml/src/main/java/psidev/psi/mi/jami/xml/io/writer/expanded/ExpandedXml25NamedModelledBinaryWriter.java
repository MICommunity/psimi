...
import psidev.psi.mi.jami.xml.io.writer.elements.impl.expanded.ExpandedXml25NamedModelledBinaryInteractionWriter;
...
/**
 * Expanded PSI-XML 2.5 writer for named modelled binary interactions (no experimental evidences).
...
public class ExpandedXml25NamedModelledBinaryWriter extends AbstractExpandedXml25Writer<ModelledBinaryInteraction>{

    public ExpandedXml25NamedModelledBinaryWriter() {
        super(ModelledBinaryInteraction.class);
    }

    public ExpandedXml25NamedModelledBinaryWriter(File file) throws IOException, XMLStreamException {
        super(ModelledBinaryInteraction.class, file);
    }

    public ExpandedXml25NamedModelledBinaryWriter(OutputStream output) throws XMLStreamException {
        super(ModelledBinaryInteraction.class, output);
    }

    public ExpandedXml25NamedModelledBinaryWriter(Writer writer) throws XMLStreamException {
        super(ModelledBinaryInteraction.class, writer);
    }

    public ExpandedXml25NamedModelledBinaryWriter(XMLStreamWriter streamWriter, PsiXml25ObjectCache cache) {
    ...
    protected void initialiseSubWriters() {
        ...
        setInteractionWriter(new ExpandedXml25NamedModelledBinaryInteractionWriter(getStreamWriter(), getElementCache(),
                aliasWriter, primaryRefWriter, secondaryRefWriter, experimentWriter,
                modelledParticipantWriter, inferredInteractionWriter, interactionTypeWriter,
                confidenceWriter, parameterWriter, attributeWriter,
                checksumWriter));
