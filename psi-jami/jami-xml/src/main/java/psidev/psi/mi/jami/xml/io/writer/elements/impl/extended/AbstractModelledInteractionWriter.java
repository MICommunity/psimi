...
public abstract class AbstractModelledInteractionWriter extends AbstractXml25InteractionWriter<ModelledInteraction, ModelledParticipant> {
    ...
    protected AbstractModelledInteractionWriter(XMLStreamWriter2 writer, PsiXml25ObjectIndex objectIndex,
                                                PsiXml25XrefWriter primaryRefWriter, PsiXml25XrefWriter secondaryRefWriter,
                                                PsiXml25ElementWriter<ModelledParticipant> participantWriter, PsiXml25ElementWriter<CvTerm> interactionTypeWriter,
    ...
    protected void writeExperimentRef(ModelledInteraction object) throws XMLStreamException {
    ...
    protected void writeExperimentDescription(ModelledInteraction object) throws XMLStreamException {
        // write experimental evidences
        if (!object.getCooperativeEffects().isEmpty()){
            CooperativeEffect effect = object.getCooperativeEffects().iterator().next();
            if (!effect.getCooperativityEvidences().isEmpty()){
