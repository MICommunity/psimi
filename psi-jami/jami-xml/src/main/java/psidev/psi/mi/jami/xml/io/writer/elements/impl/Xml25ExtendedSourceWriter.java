...
public class Xml25ExtendedSourceWriter extends Xml25SourceWriter {
    public Xml25ExtendedSourceWriter(XMLStreamWriter2 writer) {
        super(writer);
    }

    public Xml25ExtendedSourceWriter(XMLStreamWriter2 writer, PsiXml25ElementWriter<Alias> aliasWriter, PsiXml25ElementWriter<Publication> publicationWriter, PsiXml25ElementWriter<Annotation> attributeWriter, PsiXml25XrefWriter primaryRefWriter, PsiXml25XrefWriter secondaryRefWriter) {
