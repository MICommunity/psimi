...
/**
 * Unit tester for Xml25NamedFeatureWriter
 *
...
public class Xml25NamedFeatureWriterTest extends AbstractXml25WriterTest {
    ...
    public void test_write_feature_alias() throws XMLStreamException, IOException, IllegalRangeException {
        NamedFeature feature = new DefaultNamedFeature();
        feature.getRanges().add(RangeUtils.createRangeFromString("1-4"));
