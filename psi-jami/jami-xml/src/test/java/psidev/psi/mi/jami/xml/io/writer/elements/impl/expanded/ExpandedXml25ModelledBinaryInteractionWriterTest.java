...
/**
 * Unit tester for CompactXml25ModelledBinaryInteractionWriter
 *
...
public class ExpandedXml25ModelledBinaryInteractionWriterTest extends AbstractXml25WriterTest {
    ...
    public void test_write_interaction() throws XMLStreamException, IOException, IllegalRangeException {
        ...
        ExpandedXml25ModelledBinaryInteractionWriter writer = new ExpandedXml25ModelledBinaryInteractionWriter(createStreamWriter(), this.elementCache);
    ...
    public void test_write_interaction_shortName() throws XMLStreamException, IOException, IllegalRangeException {
        ModelledBinaryInteraction interaction = new DefaultModelledBinaryInteraction("interaction test");
        ModelledParticipant participant = new DefaultModelledParticipant(new DefaultProtein("protein test"));
        interaction.addParticipant(participant);
        elementCache.clear();
    ...
    public void test_write_interaction_allostery() throws XMLStreamException, IOException, IllegalRangeException {
        ...
        allostery.getCooperativityEvidences().add(new DefaultCooperativityEvidence(new DefaultPublication("xxxxxx")));
