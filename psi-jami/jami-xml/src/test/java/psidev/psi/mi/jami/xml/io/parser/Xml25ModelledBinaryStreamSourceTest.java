...
public class Xml25ModelledBinaryStreamSourceTest {
    ...
    public void validate_valid_file(){
        XmlModelledBinaryStreamSource dataSource = new XmlModelledBinaryStreamSource(Xml25ModelledBinaryStreamSourceTest.class.getResourceAsStream("/samples/21703451.xml"));
    ...
    public void validate_invalid_file(){
        XmlModelledBinaryStreamSource dataSource = new XmlModelledBinaryStreamSource(Xml25ModelledBinaryStreamSourceTest.class.getResourceAsStream("/samples/empty.xml"));
    ...
    public void parse_valid_file() throws IOException {
        XmlModelledBinaryStreamSource dataSource = new XmlModelledBinaryStreamSource(new File(Xml25ModelledBinaryStreamSourceTest.class.getResource("/samples/10049915.xml").getFile()));
    ...
    public void iterate_invalid_file(){
        XmlModelledBinaryStreamSource dataSource = new XmlModelledBinaryStreamSource(new File(Xml25ModelledBinaryStreamSourceTest.class.getResource("/samples/empty.xml").getFile()));
        Iterator<ModelledBinaryInteraction> iterator = dataSource.getInteractionsIterator();
        Assert.assertFalse(iterator.hasNext());
        Assert.assertFalse(dataSource.validateSyntax());
        dataSource.close();
