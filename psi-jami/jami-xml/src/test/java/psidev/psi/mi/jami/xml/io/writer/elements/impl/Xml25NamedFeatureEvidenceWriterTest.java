...
/**
 * Unit tester for Xml25NamedFeatureEvidenceWriter
 *
...
public class Xml25NamedFeatureEvidenceWriterTest extends AbstractXml25WriterTest {
    ...
    public void test_write_feature() throws XMLStreamException, IOException, IllegalRangeException {
        FeatureEvidence feature = new DefaultNamedFeatureEvidence();
        feature.getRanges().add(RangeUtils.createRangeFromString("1-4"));
        elementCache.clear();

        Xml25NamedFeatureEvidenceWriter writer = new Xml25NamedFeatureEvidenceWriter(createStreamWriter(), this.elementCache);
    ...
    public void test_write_feature_alias() throws XMLStreamException, IOException, IllegalRangeException {
        NamedFeature feature = new DefaultNamedFeatureEvidence();
        feature.getRanges().add(RangeUtils.createRangeFromString("1-4"));
