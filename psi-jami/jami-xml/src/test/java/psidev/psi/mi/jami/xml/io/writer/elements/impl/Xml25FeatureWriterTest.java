...
/**
 * Unit tester for Xml25FeatureWriter
 *
...
public class Xml25FeatureWriterTest extends AbstractXml25WriterTest {
    ...
    public void test_write_feature() throws XMLStreamException, IOException, IllegalRangeException {
        ...
        Xml25FeatureWriter writer = new Xml25FeatureWriter(createStreamWriter(), this.elementCache);
