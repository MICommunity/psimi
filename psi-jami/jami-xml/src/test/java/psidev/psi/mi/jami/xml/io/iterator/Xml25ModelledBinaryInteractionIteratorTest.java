...
import psidev.psi.mi.jami.xml.io.parser.Xml25ModelledBinaryParser;
...
public class Xml25ModelledBinaryInteractionIteratorTest {
    ...
    public void test_read_valid_xml25_inferred() throws PsiXmlParserException, JAXBException, XMLStreamException {
        ...
        Iterator<ModelledBinaryInteraction> iterator = new Xml25ModelledBinaryInteractionIterator(new Xml25ModelledBinaryParser(stream));
        int index = 0;
