...
/**
 * Unit tester for CompactXmlBasicInteractionWriter
 *
...
public class CompactXml25BasicInteractionWriterTest extends AbstractXml25WriterTest {
    ...
    public void test_write_interaction() throws XMLStreamException, IOException, IllegalRangeException {
        ...
        CompactXmlBasicInteractionWriter writer = new CompactXmlBasicInteractionWriter(createStreamWriter(), this.elementCache);
    ...
    public void test_write_interaction_intraMolecular() throws XMLStreamException, IOException, IllegalRangeException {
        ExtendedPsi25Interaction interaction = new XmlBasicInteraction();
        Participant participant = new DefaultParticipant(InteractorUtils.createUnknownBasicInteractor());
        interaction.addParticipant(participant);
