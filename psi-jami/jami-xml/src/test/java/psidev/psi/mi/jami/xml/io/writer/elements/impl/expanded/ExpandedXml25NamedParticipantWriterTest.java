...
/**
 * Unit tester for ExpandedNamedParticipantWriter
 *
...
public class ExpandedXml25NamedParticipantWriterTest extends AbstractXml25WriterTest {
    ...
    public void test_write_participant() throws XMLStreamException, IOException, IllegalRangeException {
        ...
        ExpandedXml25NamedParticipantWriter writer = new ExpandedXml25NamedParticipantWriter(createStreamWriter(), this.elementCache);
    ...
    public void test_write_participant_shortName() throws XMLStreamException, IOException, IllegalRangeException {
        NamedParticipant participant = new DefaultNamedParticipant(new DefaultProtein("protein test"));
        participant.getAliases().add(new DefaultAlias(new DefaultCvTerm("synonym"), "participant synonym"));
        participant.getAliases().add(new DefaultAlias("test"));
