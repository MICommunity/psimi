...
import psidev.psi.mi.jami.xml.io.writer.elements.impl.compact.xml25.XmlNamedParticipantEvidenceWriter;
...
/**
 * Unit tester for XmlNamedParticipantEvidenceWriter
 *
...
public class CompactXml25NamedParticipantEvidenceWriterTest extends AbstractXmlWriterTest {
    ...
    public void test_write_participant() throws XMLStreamException, IOException, IllegalRangeException {
        ...
        XmlNamedParticipantEvidenceWriter writer = new XmlNamedParticipantEvidenceWriter(createStreamWriter(), this.elementCache);
    ...
    public void test_write_participant_shortName() throws XMLStreamException, IOException, IllegalRangeException {
        NamedParticipant participant = new DefaultNamedParticipantEvidence(InteractorUtils.createUnknownBasicInteractor());
        participant.getAliases().add(new DefaultAlias(new DefaultCvTerm("synonym"), "participant synonym"));
        participant.getAliases().add(new DefaultAlias("test"));
