...
public class Xml25EvidenceSourceTest {
    ...
    public void validate_valid_file(){
        XmlEvidenceSource dataSource = new XmlEvidenceSource(Xml25EvidenceSourceTest.class.getResourceAsStream("/samples/21703451.xml"));
    ...
    public void validate_invalid_file(){
        XmlEvidenceSource dataSource = new XmlEvidenceSource(Xml25EvidenceSourceTest.class.getResourceAsStream("/samples/empty.xml"));
    ...
    public void parse_valid_file() throws IOException {
        XmlEvidenceSource dataSource = new XmlEvidenceSource(new File(Xml25EvidenceSourceTest.class.getResource("/samples/10049915.xml").getFile()));
    ...
    public void iterate_invalid_file(){
        XmlEvidenceSource dataSource = new XmlEvidenceSource(new File(Xml25EvidenceSourceTest.class.getResource("/samples/empty.xml").getFile()));
        Iterator<InteractionEvidence> iterator = dataSource.getInteractionsIterator();
        Assert.assertFalse(iterator.hasNext());
        Assert.assertFalse(dataSource.validateSyntax());
        dataSource.close();
