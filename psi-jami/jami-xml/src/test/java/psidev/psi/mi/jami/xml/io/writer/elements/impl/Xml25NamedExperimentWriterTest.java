...
public class Xml25NamedExperimentWriterTest extends AbstractXml25WriterTest {
    ...
    public void test_write_experiment() throws XMLStreamException, IOException {
        ...
        Xml25NamedExperimentWriter writer = new Xml25NamedExperimentWriter(createStreamWriter(), elementCache);
        writer.write(exp);
        streamWriter.flush();
    ...
    public void test_write_experiment_defaultPublication() throws XMLStreamException, IOException {
        Experiment exp = new DefaultNamedExperiment(null);
    ...
    public void test_write_experiment_names() throws XMLStreamException, IOException {
        NamedExperiment exp = new DefaultNamedExperiment(new DefaultPublication("xxxxxx"));
