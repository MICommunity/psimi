...
/**
 * Unit tester for UnambiguousExactParticipantInteractorComparator
 *
...
public class UnambiguousExactParticipantInteractorComparatorTest {

    private UnambiguousExactParticipantInteractorComparator comparator = new UnambiguousExactParticipantInteractorComparator();
    ...
    public void test_participant_null_after(){
        ...
        Assert.assertFalse(UnambiguousExactParticipantInteractorComparator.areEquals(participant1, participant2));
    }
    ...
    public void test_same_interactors_ignore_different_features(){
        ...
        Assert.assertTrue(UnambiguousExactParticipantInteractorComparator.areEquals(participant1, participant2));
    }
}
