...
/**
 * Unit tester for DefaultExactBioactiveEntityComparator
 *
...
public class DefaultExactBioactiveEntityComparatorTest {

    private DefaultExactBioactiveEntityComparator comparator = new DefaultExactBioactiveEntityComparator();
    ...
    public void test_bioactiveEntity_null_after(){
        ...
        Assert.assertFalse(DefaultExactBioactiveEntityComparator.areEquals(interactor1, interactor2));
    }
    ...
    public void test_interactor_properties_before_checksums(){
        ...
        interactor2.setInteractorType(new DefaultCvTerm("small molecule"));
    ...
    public void test_same_chebi(){
        ...
        Assert.assertTrue(DefaultExactBioactiveEntityComparator.areEquals(interactor1, interactor2));
    }
