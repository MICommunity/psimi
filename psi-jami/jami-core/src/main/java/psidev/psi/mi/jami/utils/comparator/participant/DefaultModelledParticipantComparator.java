 ...
 * If the participant is a modelledParticipantPool, it will use DefaultModelledParticipantPoolComparator.
 *
    ...
    public static boolean areEquals(ModelledParticipant bioParticipant1, ModelledParticipant bioParticipant2, boolean checkComplexesAsInteractors){
        ...
        if (bioParticipant1 == bioParticipant2){
            ...
            if (isBiologicalParticipantPool1 && isBiologicalParticipantPool2){
                return DefaultModelledParticipantPoolComparator.areEquals((ModelledParticipantPool) bioParticipant1,
