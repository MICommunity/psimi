...
public class ExperimentalEntityChangeLogger<T extends ExperimentalEntity> extends EntityChangeLogger<T> implements ExperimentalEntityChangeListener<T> {

    private static final Logger experimentalEntityChangeLogger = Logger.getLogger("ExperimentalEntityChangeLogger");
