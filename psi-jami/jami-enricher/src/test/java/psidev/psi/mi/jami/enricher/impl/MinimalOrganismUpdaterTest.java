 ...
 * @since  24/05/13
 */
public class MinimalOrganismUpdaterTest {

    private MinimalOrganismUpdater organismEnricher;
    ...
    public void initialiseFetcherAndEnricher() {
        ...
        this.organismEnricher = new MinimalOrganismUpdater(this.fetcher);
    ...
    public void test_bridgeFailure_does_not_throw_exception_when_not_persistent() throws EnricherException {
        ...
        organismEnricher = new MinimalOrganismUpdater(fetcher);
