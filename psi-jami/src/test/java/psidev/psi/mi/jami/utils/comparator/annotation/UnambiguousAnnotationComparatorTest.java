...
public class UnambiguousAnnotationComparatorTest {
    ...
    public void test_annotation_null_after() throws Exception {
        ...
        Annotation annotation2 = new DefaultAnnotation(CvTermFactory.createComplexPhysicalProperties(), "Molecular mass = 154 kDa");
    ...
    public void test_annotation_value_comparison() throws Exception {
        Annotation annotation1 = new DefaultAnnotation(CvTermFactory.createComplexPhysicalProperties(), "Molecular mass = 170 kDa");
        Annotation annotation2 = new DefaultAnnotation(CvTermFactory.createComplexPhysicalProperties(), "Molecular mass = 154 kDa");
    ...
    public void test_annotation_value_case_insensitive() throws Exception {
        Annotation annotation1 = new DefaultAnnotation(CvTermFactory.createComplexPhysicalProperties(), "Molecular mass = 170 kDa");
        Annotation annotation2 = new DefaultAnnotation(CvTermFactory.createComplexPhysicalProperties(), "Molecular MASS = 170 kDa ");
