...
public interface Protein extends Interactor {
     ...
     * It is a shortcut which should point to the first uniprotkb identifier in the list of identifiers.
     * Ex: P12345, P12345-1
     ...
     * It will remove the old uniprotkb identifier from the list of identifiers and replace it
     ...
     * It is a shortcut which should point to the first gene name in the list of aliases.
     * Ex: BRCA2
    ...
    /**
     * Sets the gene name.
     * It will remove the old gene name from the list of aliases and replace it
     ...
     * It is a shortcut which should point to the first rogid identifier in the list of checksums.
    ...
    /**
     * Sets the rogid.
     * It will remove the old rogid from the list of checksums and replace it
