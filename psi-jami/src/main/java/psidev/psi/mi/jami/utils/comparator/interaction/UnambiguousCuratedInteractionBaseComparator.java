...
public class UnambiguousCuratedInteractionBaseComparator extends CuratedInteractionBaseComparator {
    ...
    private static UnambiguousCuratedInteractionBaseComparator unambiguousCuratedInteractionComparator;

    /**
     * Creates a new UnambiguousCuratedInteractionBaseComparator. It will use a UnambiguousParticipantBaseComparator to
    ...
    public static boolean areEquals(Interaction interaction1, Interaction interaction2){
        if (unambiguousCuratedInteractionComparator == null){
            unambiguousCuratedInteractionComparator = new UnambiguousCuratedInteractionBaseComparator();
        }
    ...
    public static int hashCode(Interaction interaction){
        ...
        Collections.sort(list1, unambiguousCuratedInteractionComparator.getParticipantCollectionComparator().getObjectComparator());
