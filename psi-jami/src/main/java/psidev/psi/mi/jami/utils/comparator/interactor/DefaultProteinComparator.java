 ...
 * If the properties of a protein were not enough to compare the proteins, it will use DefaultInteractorComparator to compare the interactor properties
 *
 *
...
public class DefaultProteinComparator extends ProteinComparator {
    ...
    /**
     * Creates a new DefaultProteinComparator. It will uses a DefaultInteractorComparator to compare interactor properties and a
