 ...
 *
 * It will first compare the participants using UnambiguousParticipantComparator. If the participants are the same, it will compare
...
public class UnambiguousInteractionComparator extends InteractionComparator {
    ...
    /**
     * Creates a new UnambiguousInteractionComparator. It will use a UnambiguousParticipantComparator to
