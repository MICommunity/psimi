 ...
 * If the properties of a gene were not enough to compare the genes, it will use UnambiguousInteractorComparator to compare the interactor properties
 *
...
public class UnambiguousGeneComparator extends GeneComparator {
    ...
    /**
     * Creates a new UnambiguousGeneComparator. It will uses a UnambiguousInteractorComparator to compare interactor properties
     */
